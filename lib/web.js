    ...
    try {
      ...
      switch (method) {
        ...
        case 'search':
          ...
          break
        case 'stats':
          value = store.stats(caller, a)
          break
        case 'fact-review':
          value = store.reviewFacts(caller, a)
          break
        case 'fact-decide':
          value = await store.decideFact(caller, a)
          break
        case 'mutate':
        ...
        case 'evidence':
          value = { evidence: store.evidence(caller, a) }
          break
        case 'validate':
        ...
        case 'queue-maintenance':
          if (typeof a.dryRun !== 'boolean')
            fail('invalid-input', 'Choose preview or exact application')
          value = await store.maintainQueue(caller, a)
          break
        case 'maintenance':
        ...
        case 'outcome-options':
          value = store.outcomeOptions(caller, a)
          break
        case 'outcome':
