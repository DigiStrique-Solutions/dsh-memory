...
const report = {
  ...
  gate: 'not-evaluated',
  notes: [
    'This supplied-procedure benchmark cannot authorize learning. Safety fixtures are not evidence of a task-success improvement. No unattended admission is enabled.'
  ]
}
